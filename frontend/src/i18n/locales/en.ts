export default {
  ...
  requests: {
    ...
    streamRequests: 'Stream Requests',
    errorRate: 'Error Rate',
    streamRate: 'Stream Rate',
    avgDuration: 'Average Duration',
    inSelectedRange: 'In selected time range',
    perRequest: 'Per request',
  ...
  admin: {
    ...
    requests: {
      title: 'Request Logs',
      description: 'View and manage all users\' request logs',
      totalRequests: 'Total Requests',
      errorRequests: 'Error Requests',
      streamRequests: 'Stream Requests',
      errorRate: 'Error Rate',
      ...
      apiKeyIdPlaceholder: 'Enter API Key ID',
