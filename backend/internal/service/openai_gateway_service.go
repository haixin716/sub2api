...
type OpenAIForwardResult struct {
	...
	// ServiceTier records the OpenAI Responses API service tier.
	ServiceTier *string
	// ReasoningEffort is extracted from request body or derived from model suffix.
...
func (s *OpenAIGatewayService) forwardOpenAIPassthrough(
	...
	if clientReqID == "" {
		...
		logger.LegacyPrintf("service.openai_gateway", "Warning: ClientRequestID not found in context, generated new UUID: %s", clientReqID)
	}
