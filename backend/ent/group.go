...
// was not loaded in eager-loading.
func (e GroupEdges) RequestLogsOrErr() ([]*RequestLog, error) {
	if e.loadedTypes[4] {
...
// QueryRequestLogs queries the "request_logs" edge of the Group entity.
func (_m *Group) QueryRequestLogs() *RequestLogQuery {
	return NewGroupClient(_m.config).QueryRequestLogs(_m)
}
