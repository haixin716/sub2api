...
// was not loaded in eager-loading.
func (e AccountEdges) RequestLogsOrErr() ([]*RequestLog, error) {
	if e.loadedTypes[3] {
...
// QueryRequestLogs queries the "request_logs" edge of the Account entity.
func (_m *Account) QueryRequestLogs() *RequestLogQuery {
	return NewAccountClient(_m.config).QueryRequestLogs(_m)
}
